"""
RGBMatrix32x64 v 0.2.1
Library for RGB Matrix 32x64
...
class RGBMatrix32x64( DRAW_FB_G8 ):
    # Define screen dimensions
    WIDTH  = const(64)
    HEIGHT = const(32)
    LOOP_DELAY = const(1000) # delay in us: 100..2000

    def __init__( self, r1, g1, b1, r2, g2, b2, clk, lat, oe, a, b, c, d,
        ...
        for p in (r1, g1, b1, r2, g2, b2, clk, lat, oe, a, b, c, d):
            if p > 31:
